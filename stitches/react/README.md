...
**@fuel-stitches/react** is a react implementation of [stitches](https://stitches.dev), a CSS-in-JS library with a best-in-class developer experience.

<p><br /></p>

```sh
# with npm
npm install @fuel-stitches/react

# with yarn
yarn add @fuel-stitches/react
```
...
```html
<script type="module">
  import { styled } from 'https://cdn.skypack.dev/@fuel-stitches/react';
</script>
```
...
```js
<script src="https://unpkg.com/@fuel-stitches/react/dist/index.global.js"></script>
<script>
