...
**@fuel-stitches/core** is a framework-agnostic implementation of [stitches](https://stitches.dev), a CSS-in-JS library with a best-in-class developer experience.

<p><br /></p>

```sh
# with npm
npm install @fuel-stitches/core

# with yarn
yarn add @fuel-stitches/core
```
...
```js
<script src="https://unpkg.com/@fuel-stitches/core/dist/index.global.js"></script>
<script>
